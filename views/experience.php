        					...
        					<li>
        						...
        						<div class="timeline-panel">
        							<div class="timeline-heading">
        								<h4 class="timeline-title">Application Support Analyst</h4>
        								<h5><strong>Moody's</strong> - Bureau van Dijk</h5>
        								<p>
        									<small class="text-muted"><i class="fa fa-calendar-o"></i>
        										Jan 2017 - Present</small>
        									<br/>
